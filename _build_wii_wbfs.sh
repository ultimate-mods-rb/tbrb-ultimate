...
rm ./iso/TBRB\ Ultimate.wbfs
dependencies/wit/wit copy ./_build/wii ./iso/TBRB\ Ultimate.wbfs

echo "TBRB ultimate should've successfully built. copy the wbfs to your console to play. enjoy :)"