...
"%~dp0dependencies/wit/wit" copy "%~dp0\_build\wii" "%~dp0\iso\TBRB Ultimate.wbfs"

echo:
if %FAILED_ARK_BUILD% neq 1 (echo:TBRB ultimate should've successfully built. A wbfs has been generated in the iso folder)
