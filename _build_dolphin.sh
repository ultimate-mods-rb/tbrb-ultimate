...
if [ "$FAILED_ARK_BUILD" -ne 1 ]; then
    echo "Successfully built The Beatles Rock Band Ultimate ARK files. Make sure to add _build/wii as a game path in Dolphin and enable search subfolders so it will show up."
else
