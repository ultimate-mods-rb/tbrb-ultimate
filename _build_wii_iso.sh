...
rm ./iso/TBRB\ Ultimate.iso
dependencies/wit/wit copy ./_build/wii ./iso/TBRB\ Ultimate.iso

echo "TBRB ultimate should've successfully built. copy the iso to your console to play. enjoy :)"