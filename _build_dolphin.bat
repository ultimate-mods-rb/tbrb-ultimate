...
echo:
if %FAILED_ARK_BUILD% neq 1 (echo:TBRB ultimate should've successfully built. make sure to add _build/wii as a game path in dolphin and enable search subfolders so it will show up. enjoy :)
